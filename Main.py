...
def main():
	...
	while True:
		...
		for idx in range(0,NUM_CH):
            ...
            # # 白白白白 0000 前進
            # if (photorefs[0] < 0.5 and photorefs[1] < 0.5 and photorefs[2] < 0.5 and photorefs[3] < 0.5) :
            #     # 0.2秒前進(50%)
		    #     motors.forward(speed=0.5)
		    #     sleep(0.5)
			
            # # 白白黒黒 0011 右逆左正
            # elif (photorefs[0] < 0.5 and photorefs[1] < 0.5 and photorefs[2] > 0.5 and photorefs[3] > 0.5):
		    # 	# 0.2秒右カーブ(40%)逆転
